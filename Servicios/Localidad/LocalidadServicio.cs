...
namespace Servicios.Localidad
{
    public class LocalidadServicio : ILocalidadServicio
    {
        ...
        {
            return _unidadDeTrabajo.LocalidadRepositorio.Obtener(x => x.Descripcion.Contains(cadenaBuscar)
                    || x.Departamento.Descripcion.Contains(cadenaBuscar)
                    || x.Departamento.Provincia.Descripcion.Contains(cadenaBuscar), "Departamento, Departamento.Provincia")
