    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            try
            {
                ...
                {
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.A });
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.B });
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.C });
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.NotaCredito });
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.Presupuesto });
                    context.Contadores.Add(new Contador
                    { EstaEliminado = false, Valor = 0, TipoComprobante = TipoComprobante.Remito });
