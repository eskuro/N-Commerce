namespace Infraestructura.Migrations
{
    ...
    public partial class mapeoIni : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Localidad", t => t.LocalidadId)
                .ForeignKey("dbo.Precio", t => t.Precio_Id)
                .Index(t => t.LocalidadId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Movimiento_CuentaCorrienteProveedor", "UsuarioId", "dbo.Usuario");
            DropForeignKey("dbo.Movimiento_CuentaCorrienteProveedor", "ProveedorId", "dbo.Proveedor");
            DropForeignKey("dbo.Movimiento_CuentaCorrienteProveedor", "ComprobanteId", "dbo.Comprobante");
            DropForeignKey("dbo.Proveedor", "LocalidadId", "dbo.Localidad");
            DropForeignKey("dbo.Proveedor", "CondicionIvaId", "dbo.CondicionIva");
            DropForeignKey("dbo.Movimiento_CuentaCorriente", "UsuarioId", "dbo.Usuario");
            ...
            DropForeignKey("dbo.Movimiento_CuentaCorriente", "ComprobanteId", "dbo.Comprobante");
            ...
            DropForeignKey("dbo.Configuracion", "Precio_Id", "dbo.Precio");
            ...
            DropIndex("dbo.Movimiento_CuentaCorrienteProveedor", new[] { "UsuarioId" });
            DropIndex("dbo.Movimiento_CuentaCorrienteProveedor", new[] { "ComprobanteId" });
            ...
            DropIndex("dbo.Movimiento_CuentaCorriente", new[] { "UsuarioId" });
            DropIndex("dbo.Movimiento_CuentaCorriente", new[] { "ComprobanteId" });
            ...
            DropIndex("dbo.Configuracion", new[] { "Precio_Id" });
